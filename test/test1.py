...
#Test cases for CFA clssification method
...
print(classify.CFA(language_corpuses, data, N_GRAM_LEN))
...
print(classify.CFA(language_corpuses, data1, N_GRAM_LEN))
...
print(classify.CFA(language_corpuses, data2, N_GRAM_LEN))
